        ...
        <div className="bg-white p-8 md:p-12 rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-gray-50 w-full max-w-[480px] m-auto group transition-all duration-500 hover:shadow-[0_40px_80px_rgba(0,0,0,0.08)]">
          <div className="text-center mb-10">
              <div className="w-16 h-16 bg-primary/10 rounded-2xl flex items-center justify-center mx-auto mb-6 transform group-hover:rotate-12 transition-transform duration-500">
                  <span className="text-2xl text-primary font-black">L</span>
              </div>
              <h1 className="text-[28px] md:text-[32px] font-black text-gray-800 tracking-tight">
                Welcome Back
              </h1>
              <p className="text-gray-400 text-[14px] mt-2 font-medium">Please enter your details to sign in.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-end">
              <Link
                ...
                className="text-[13px] font-black text-gray-300 hover:text-primary transition-colors uppercase tracking-widest"
              >
                Forgot?
              </Link>
            </div>
            ...
            <Button
              type="submit"
              className="w-full !bg-primary !text-white !py-4 !rounded-2xl !text-[16px] !font-black !capitalize shadow-xl shadow-primary/20 hover:scale-[1.02] active:scale-95 transition-all"
          ...
          <div className="relative my-10 text-center">
              ...
              <span className="relative px-4 bg-white text-[12px] font-black text-gray-300 uppercase tracking-widest">Or continue with</span>
          </div>
